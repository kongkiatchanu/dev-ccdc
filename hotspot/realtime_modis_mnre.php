...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap-theme.min.css" integrity="sha384-fLW2N01lMqjakBkx3l/M9EahuwpSfeNvV63J5ezn3uZzapT0u7EYsXMjQV+0En5r" crossorigin="anonymous">
    ...
    <style>
      ...
      #map-outer {height: 650px; padding: 20px; border: 2px solid #CCC; margin-bottom: 20px; background-color:#FFF }
	  #map { height: 600px }
...
/*
SELECT CAST(CONCAT(DATE_FORMAT(NOW(), '%Y-%m-%d'),' ','00:00:00') AS DATETIME) AS dtstart
*/
	...
	$sql = "
		...
		WHERE (((CAST(CONCAT(acq_date,' ',acq_time) AS DATETIME)  + INTERVAL 7 HOUR)) BETWEEN (CAST(CONCAT(DATE_FORMAT(NOW(), '%Y-%m-%d'),' ','00:00:00') AS DATETIME) - INTERVAL ".$sql_period." HOUR) AND CAST(CONCAT(DATE_FORMAT(NOW(), '%Y-%m-%d'),' ','23:59:59') AS DATETIME))
...
// 			  });
    ...
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAg79jeP4V_QoMuchIFak923yM32gfOCHU&callback=initMap">
    		...
    		<h4><font color="red">MODIS Near Real Time : Total <?php echo $total_hotspot; ?> hotspot(s).</h4>
    		<div class="container">
			<div class="row">
				<div id="map-outer" class="col-md-12">
					<div class="col-md-2">
						<form id="realtime_modis" name="realtime_modis" method="POST" action="realtime_modis_mnre.php">
					...
					?>
						...
						<br/>
						<input type="submit" class="btn-success" value="Query Modis">
						</form>
	<!--				<select name="region">
