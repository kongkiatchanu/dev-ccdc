...
<html lang="en">
  ...
  <body>
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('zmap'), {
          zoom: 8,
...
// 			  });
    ...
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAg79jeP4V_QoMuchIFak923yM32gfOCHU&callback=initMap">
		...
		<h2 class="text-center">รายงานสถานการณ์ไฟป่า ย้อนหลัง <?=$period?> ชั่วโมง</h2>
		<h2 class="text-center">พบจุดความร้อน(Hotspot) บริเวณพื้นที่ในจังหวัด<?php echo $province; ?> ทั้งหมด <?php echo $total_hotspot; ?> จุด</h2>

			<div id="map-outer" class="col-md-12">
				<div id="zmap"></div>
				<div id="filter" style="position: absolute;top: 20px;right:0;">

					<a href="http://www.cmuccdc.org/Hotspot" class="btn btn-success">View All Modis</a>
